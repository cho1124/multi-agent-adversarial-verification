...
- [청크 ID 안정성](docs/improvements/01-청크ID-안정성.md) — 7번 재설계, content_hash + 매핑 테이블
- [인용 정합성](docs/improvements/02-인용-정합성.md) — span 3단계 폴백 + 2단계 IoU
- [캐시 무효화](docs/improvements/03-캐시-무효화.md) — 3계층 동시 무효화
- [환각 방지](docs/improvements/04-환각-방지.md) — sufficiency gate 2단계 임계값
- [스트리밍 + 인용](docs/improvements/05-스트리밍-인용.md) — 문장 버퍼 SSE
- [레이아웃 보존](docs/improvements/06-레이아웃-보존.md) — 텍스트+레이아웃 동시 추출
- [비용 통제](docs/improvements/07-비용-통제.md) — 로컬 우선 ~$15/월
